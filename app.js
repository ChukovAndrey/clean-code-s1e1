...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="todo__button_edit btn";

    deleteButton.innerText="Delete";
    deleteButton.className="todo__button_delete btn";
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.todo__text');
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    var listItemLabel = listItem.querySelector(".todo__label");
    listItemLabel.classList.add("todo__label_complited");
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    var listItemLabel = listItem.querySelector(".todo__label");
    listItemLabel.classList.remove("todo__label_complited")
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
